...
for (t in n0:n1){
  ...
  E3diff[t-n0+1] = E31[t-n0+1] - 3*E32[t-n0+1] + 3*E33[t-n0+1] - E34[t-n0+1]
  
  E[t-n0+1] = -k*(n - 2*t)
  Var[t-n0+1] = (t*(- n*k^2 + R2)*(n - t))/(n*(n - 1))
  Gamma[t-n0+1] = (E3diff[t-n0+1] - 3*E[t-n0+1]*Var[t-n0+1] - E[t-n0+1]^3)/((Var[t-n0+1])^1.5)
